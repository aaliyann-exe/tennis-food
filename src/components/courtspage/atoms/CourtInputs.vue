    ...
    <div :disabled="isReadOnly" :class="(isReadOnly ? 'cursor-not-allowed ' : '') + 'col-span-1 p-2'">
        ...
        <div v-if="isDropDown" class="relative" ref="dropdownRef">
            ...
            <div @click="toggleDropdown"
                :class="(isOpen ? 'border-primary ring-4 ring-orange-50 bg-white ' : 'border-gray-200 bg-gray-50 ') + (isReadOnly ? 'bg-gray-50 cursor-not-allowed ' : 'bg-secondary cursor-pointer ') + 'flex items-center w-full p-2.5 border rounded-lg'">
            ...
            <transition name="fade">
                ...
                <div v-if="isOpen"
                    ...
                    <div class="overflow-y-auto max-h-60 custom-scrollbar">
                        ...
                        <div v-for="option in props.options" :key="option" @click="selectOption(option)"
                            class="flex items-center justify-between px-4 py-3 transition-colors cursor-pointer hover:bg-blue-50">

                            <span
                                :class="['text-sm', props.inputData === option ? 'text-primary font-semibold' : 'text-gray-700']">
        ...
        <div v-else :class="[
            ...
            <input :value="props.inputData" :required="props.mustFill" :disabled="isReadOnly" type="text"
                @blur="handleBlur" @input="handleInput" :placeholder="props.inputPlaceholder" :class="[
