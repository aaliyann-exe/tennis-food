...
const fillForm = () => {
  if (props.mode === "create") {
    ...
    form.phone =
      props.clubData.phone === "N/A" ? "" : props.clubData.phone || "";
    ...
    >
      <div class="flex items-center justify-between px-8 py-5">
        ...
        <div class="flex items-center gap-4">
          <button
            v-if="props.mode === 'view'"
            class="absolute cursor-pointer top-21 right-100"
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-6">
          <ClubInputs
            v-model:inputData="form.clubName"
            :inputLabel="'Club ' + $t('table.name')"
            :inputPlaceholder="'Club ' + $t('table.name')"
            :icon="clubsIcon"
            mustFill
            hasAsterisk
            :validationMessage="
              'Club/' +
              $t('modalField.association') +
              ' ' +
              $t('modalField.error')
            "
            :mode="props.mode"
          ...
          <ClubInputs
            inputLabel="School"
            inputPlaceholder="Royal Dutch Tennis"
            :icon="buildingIcon"
            isDropDown
            isDisabled
            :mode="props.mode"
