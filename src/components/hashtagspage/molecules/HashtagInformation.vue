    ...
    <div class="h-max w-150 bg-white shadow-xl rounded-2xl">
      <div class="flex items-center justify-between py-5">
        ...
        <h2
          ...
          class="mt-2 relative left-12 text-4xl font-semibold"
        >
        ...
        <button
          v-if="props.mode === 'view'"
          class="absolute cursor-pointer right-134"
      ...
      >
        <div class="grid grid-cols-1">
          <HashtagInputs
            v-model:inputData="form.title"
            inputLabel="Hashtag"
            inputPlaceholder="Hashtag"
            :icon="personIcon"
            mustFill
            hasAsterisk
            validationMessage="Hashtag is required"
            :mode="props.mode"
          />
        </div>
