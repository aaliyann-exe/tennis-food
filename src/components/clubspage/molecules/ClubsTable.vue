    ...
    >
      <table class="w-full text-left border-collapse table-fixed">
        ...
        <tbody class="divide-y divide-gray-300">
          <tr
            v-for="(club, index) in props.clubs"
            :key="index"
          ...
          >
            ...
            <td class="px-6 py-4 text-right">
              <div class="flex items-center justify-end gap-3 opacity-50">
                ...
                <button
                  class="cursor-pointer"
                  @click="handleToggleStatus(club)"
                  :title="
                    club.status ? $t('table.activate') : $t('table.deactivate')
                  "
                >
                  <img
                    :src="club.status ? deactivateIcon : activateIcon"
