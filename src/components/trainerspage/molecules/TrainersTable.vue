          ...
          <tr v-for="(trainer, index) in props.trainers" :key="index" class="hover:bg-other">
            ...
            <td class="px-6 py-4">
              ...
              <div class="flex items-center gap-4">
                ...
                <div v-if="trainer.pfp" class="shrink-0 w-10 h-10 overflow-hidden rounded-full">

                   <img :src="trainer.pfp" alt="Trainer logo" class="object-cover w-full h-full" />
            ...
            <td class="px-6 py-4 text-right">
              ...
              <span v-if="trainer.status" class="inline-block text-center w-24 py-1 text-xs font-medium border rounded-full text-active-dark bg-active border-active-dark">
            ...
            <td class="px-6 py-4 text-right">
              ...
              <div class="flex items-center justify-end gap-3 opacity-50">
                ...
                <button class="cursor-pointer" @click="$emit('view', trainer)" :title="$t('table.view')">

                  <img :src="viewIcon" class="w-5 h-5" />

                </button>

                <button class="cursor-pointer" @click="$emit('edit', trainer)" title="$t('table.edit')">

                  <img :src="editIcon" class="w-5 h-5" />

                </button>

                <button class="cursor-pointer" @click="handleToggleStatus(trainer)" :title="(trainer.status ? $t('table.deactivate'): $t('table.activate'))">
