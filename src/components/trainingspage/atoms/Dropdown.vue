...
<template>
  ...
  <div class="p-8 w-80">
    ...
    <div class="relative">
      ...
      <button @click="isOpen = !isOpen" :class="(isOpen ? 'border-orange-200 ring-4 ring-orange-50 ' : 'border-gray-200 ') + 'w-full flex items-center justify-between px-4 py-3 border rounded-xl transition-all'">
        ...
        <svg :class="(isOpen ? 'rotate-180 ' : '') + 'w-5 h-5 text-gray-400 transition-transform'" fill="none" stroke="currentColor" viewBox="0 0 24 24"
        >
